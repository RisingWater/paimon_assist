...
class AddReminderTool(BaseTool):
    def __init__(self):
        super().__init__(
            ...
            memory_value=5, final=True,
        )

    def execute(self, args: dict) -> str:
        try:
            uid = db._ensure_reminder_user()
            db.add_reminder(uid, args["content"], args["rtype"],
...
class DeleteReminderTool(BaseTool):
    def __init__(self):
        super().__init__(
            ...
            memory_value=1, silent=True, final=True,
        )
...
tools.register(AddReminderTool())
tools.register(ListRemindersTool())
tools.register(DeleteReminderTool())
